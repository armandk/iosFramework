...
@interface ABPExpiryError : NSObject
...
-(void) getTokenWithOldToken:(NSString* _Nullable)oldToken completionHandler:(void (^ _Nonnull)(ABPToken* _Nullable, ABPExpiryError* _Nullable))completionHandler;
...
-(id _Nonnull) initWithChallengeUrl:(NSURL * _Nonnull)challengeUrl_
                           debugKey:(NSString * _Nullable)debugKey
                     sendBiometrics:(BOOL)sendBiometrics_;
