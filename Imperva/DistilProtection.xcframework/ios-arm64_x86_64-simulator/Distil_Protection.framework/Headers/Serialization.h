...
@interface ABPAuthenticationProtocol : NSObject
...
@interface ABPChallenge : NSObject <Deserialize>
...
@interface ABPToken : NSObject <Deserialize>
...
NSString* _Nullable encodeResponse(NSString* _Nonnull session,
                                   ...
                                   NSString* _Nonnull sbs,
                                   NSError* _Nonnull * _Nullable error);


@interface ABPExpiryToken : NSObject <Deserialize>
