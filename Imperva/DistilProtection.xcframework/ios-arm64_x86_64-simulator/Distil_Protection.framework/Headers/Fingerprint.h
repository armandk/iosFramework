...
@interface ABPSystemInformation : NSObject
...
@interface ABPFingerprint : NSObject

@property ABPSystemInformation * _Nonnull identb5b13193f2e0fadf91b5c67d0f59cc98;
...
NSDictionary* _Nonnull fingerprintPropertyList(ABPFingerprint* _Nonnull fingerprint);
